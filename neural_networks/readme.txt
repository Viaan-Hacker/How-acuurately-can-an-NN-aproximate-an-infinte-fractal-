...
In Julia.ipynb we generated and used the julia dataset for modeling.
Comparing models.ipynb We generated different Models for the mandelbrot set to conduct our final experiments.



You can reproduce our results in the Comparing Models.ipynb file, in order of the code blocks from top to bottom.